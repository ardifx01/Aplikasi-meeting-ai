<?php
/**
 * Test script untuk memastikan AI booking bisa dihapus dari database
 */

echo "=== TEST AI BOOKING DELETE ===\n\n";
...
if ($responseData && $responseData['success']) {
    ...
    if ($aiBookingsData && isset($aiBookingsData['data'])) {
        ...
        if ($aiBookingCount > 0) {
            ...
            $deleteUrl = "http://127.0.0.1:8080/backend/api/bookings.php/ai-cancel/$bookingId";
            $deleteCh = curl_init();
